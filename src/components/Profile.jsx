...
function Profile() {
  ...
  return (
    ...
    <ul className="contact-list">
          ...
          <li className='social'>
            <a href="https://de.linkedin.com/" target="_blank" aria-label="View LnkedIn Profile" rel="noopener noreferrer">
              <svg
            ...
            <a href="https://github.com/" target="_blank" aria-label="View GitHub Profile"  rel="noopener noreferrer">
              <svg
                className="contact-icon link"
                xmlns="http://www.w3.org/2000/svg"
                width="30"
